...
- [Password Expiration](#part-1---password-expiration)
- [Password History](#part-2---password-history)
- [Password Complexity](#part-3---password-complexity)

In addition, you can find the details of 

[Default Password Policy](#part-4---default-password-policy-settings-in-loginradius)

[Password Compliance Check](#part-5---password-compliance-check)

[Password Hashing](#part-6---password-hashing-algorithm) 

[Password Visibility](#part-7---password-visibility)
...
- [Common Password Protection](#common-password-protection)
- [Dictionary Password Prevention](#dictionary-password-prevention)
- [Profile Fields Password Prevention](#profile-fields-password-prevention)
...
For more details on the password validations, refer to the [validation rules list](https://www.loginradius.com/docs/api/v2/deployment/js-libraries/javascript-hooks/#passwordstrengthfeature21).
...
> **Note:** You can refer to this [document](https://www.loginradius.com/docs/authentication/concepts/common-password/) for a common password list maintained by LoginRadius and this list is dynamic and it gets updated from time to time.
...
For additional information on the usage of custom validation hooks, validation rules, and custom validation rules, please see this [documentation](https://www.loginradius.com/docs/api/v2/deployment/js-libraries/javascript-hooks#customvalidationhook15).
...
For more details on password hashing, password salting and upgrading the hashing algorithms , you can refer to [this document](https://www.loginradius.com/docs/authentication/concepts/password-hashing-and-salting/).

If you want to change the Hashing Algorithm, click the **REQUEST CHANGE** button and raise the support ticket. [This document](https://www.loginradius.com/docs/authentication/concepts/password-hashing-and-salting/) explains how LoginRadius will handle hashing of existing and new customers password in case of hashing algorithm upgrade.
