...
- **Captcha:** Select this option to prompt the customer to complete a [Captcha](https://www.loginradius.com/docs/authentication/concepts/customer-security/#partcaptcha0) to log in, if the account is locked.
