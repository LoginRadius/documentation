...
> **Note:** This JWT API endpoint will be deprecated soon. Refer to the new [JWT Implementation Guide](https://www.loginradius.com/docs/single-sign-on/tutorial/Federated-SSO/JWT-login/JWT-implementation-guide/) for the latest JWT API endpoint.
